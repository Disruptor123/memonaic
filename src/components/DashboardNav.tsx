      ...
      <div className="container mx-auto px-6">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Button variant="outline" size="sm" className="border-red-500 text-red-300 hover:bg-red-500/10">
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 border-t border-red-500/30">
            ...
            <Button variant="outline" size="sm" className="border-red-500 text-red-300 hover:bg-red-500/10 mt-4">
              <LogOut className="h-4 w-4 mr-2" />
              Logout
            </Button>
          </div>
